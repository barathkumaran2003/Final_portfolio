    ...
    <>
      <div>
          ...
          <div style={{ paddingTop: "160px" }}>
            <div className="blackw">
              <div className="in-animation7">
                <h1 className="head1hotel">Crown Template<samp className="dot">.</samp></h1>
                <div className="in-animation4">
                  <h3 className="head12">
                  This page contains the case study of Crown Template Open-Source Project which includes the                   </h3>
                  <p className="para">
        ...
        <div className="bg1" id="ABOUT">
          <div className="in-animation7">
            <img src="/photal.png" alt="pointer" className="picture" />
          </div>
          ...
          <div className="overviews">
            ...
            <div className="in-animation5">
              ...
              <div style={{ display: "flex", marginTop: "35px" }}>
                <div style={{ marginRight: "15px" }} className="toolj"><samp>Spring Boot</samp></div>
              ...
              <div style={{display: 'flex', marginTop: "35px"}}>
                <div style={{ marginRight: "15px",  }} className="toolj"><samp>java</samp></div>
                <div style={{ marginRight: "15px" }} className="toolj"><samp>My Sql</samp></div>
              </div>
            </div>
          </div>
            ...
            <div className="overviewsa">
              ...
              <div style={{ display: "flex" }}>
                <div className="buttona" style={{ backgroundColor: 'blueviolet' }}>
                  <a href="https://barathkumaran2003.github.io/Project/"><p>LIVE LINK</p></a>
                </div>
