...
function Point_Expert_Case_Study() {
  return (
    <>
      <div>
          ...
          <div style={{ paddingTop: "160px" }}>
            <div className="blackw">
              <div className="in-animation7">
                <h1 className="head1point">Point Expert<samp className="dot">.</samp></h1>
                <div className="in-animation4">
                  <h3 className="head12">
                    This page contains the case study of Point.Expert - Flight Booking Platform Open-Source Project which includes the
                  </h3>
                  <p className="para">
        ...
        <div className="bg1" id="ABOUT">
          <div className="in-animation7">
            <img src="/Point expert 1.png" alt="pointer" className="picture" />
          </div>
            ...
            <div className="overviewsa">
              ...
              <div style={{ display: "flex" }}>
                <div className="buttona" style={{ backgroundColor: 'blueviolet' }}>
                  <a href="https://pointexpert.vercel.app/"><p>LIVE LINK</p></a>
                </div>
...
export default Point_Expert_Case_Study;
